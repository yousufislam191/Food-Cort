...
<body id="body-pd">
    ...
    <section>
        <div class="row" id="adminProfile">
                ...
                <div class="row">
                    <div class="col-md-7 col-6">
                        <div>
                            ...
                            <img src="../assets/default_img/default_profile.png"
                                class=" img-thumbnail rounded adminProfileimg" name="selectimg" alt="" value="">
                            <?php
                                }
                            }
                            ?>
                    ...
                    <div class="col-md-5 col-6">
                        <form>
                            <button class="btn btn-primary mb-3 me-3 btn-file" style="transition: .3s;">Browse Image
                                <input type="file" id="adminformFile" name="image" accept=".jpg, .jpeg, .png"
                                    onclick="return getAdminImage();">
                            </button>
                        </form>
                        <button class="btn btn-success" id="adminImgSubmit" type="submit"
                            style="transition: .3s;">Save</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-middle gap-3">
                            ...
                            <input type="text" class="form-control" id="facebook" name="facebook"
                                placeholder="facebook url" value="<?php echo $row['fb'] ?>">
                            <?php
                            }
                            ?>
                            <span class="material-symbols-outlined donebtn facebook"
                                style="cursor: pointer;">done</span>
                        </div>
                    </div><br>
                    <div class="form-group">
                        ...
                        <div class="d-flex align-middle gap-3">
                            ...
                            include '../serverSite/adminProfileGet.php';
                            while ($row = mysqli_fetch_array($result)) { ?>
                            <input type="text" required class="form-control" id="instagram" name="instagram"
                                placeholder="instagram url" value="<?php echo $row['instagram'] ?>">
                            <?php
                            }
                            ?>
                            <span class="material-symbols-outlined donebtn instagram"
                                style="cursor: pointer;">done</span>
                        </div>
                    </div><br>
                    <div class="form-group">
                        ...
                        <div class="d-flex align-middle gap-3">
                            ...
                            include '../serverSite/adminProfileGet.php';
                            while ($row = mysqli_fetch_array($result)) { ?>
                            <input type="text" required class="form-control" id="skype" name="skype"
                                placeholder="skype url" value="<?php echo $row['skype'] ?>">
                            <?php
                            }
                            ?>
                ...
                <form action="../serverSite/adminProfileSubmit.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="d-flex align-middle gap-3">
                            ...
                            include '../serverSite/adminProfileGet.php';
                            while ($row = mysqli_fetch_array($result)) { ?>
                            <input type="text" required class="form-control" id="linkedin" name="linkedin"
                                placeholder="linkedin url" value="<?php echo $row['linkedin'] ?>">
                            <?php
                            }
                            ?>
                            <span class="material-symbols-outlined donebtn linkedin"
                                style="cursor: pointer;">done</span>
                        </div>
                    </div><br>
                    <div class="form-group">
                        ...
                        <div class="d-flex align-middle gap-3">
                            ...
                            include '../serverSite/adminProfileGet.php';
                            while ($row = mysqli_fetch_array($result)) { ?>
                            <input type="text" required class="form-control" id="twiter" name="twiter"
                                placeholder="twitter url" value="<?php echo $row['twiter'] ?>">
                            <?php
                            }
                            ?>
            ...
            <div class="col-md-4 col-12 gap-3 mb-3 mt-3">
                <div class="row">
                    <div class="col-md-7 col-6">
                        <h4>Website Logo</h4>
                        <div>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                if (!empty($row['web_img'])) {
                                    echo "<img src='../$row[web_img]' alt='' class=' img-thumbnail rounded putwebLogo' name='putwebLogo'>";
                                } else { ?>
                            <img src="../assets/logo/default_logo.png" class=" img-thumbnail rounded webLogoimpot"
                                name="webLogo" alt="" value="">
                            <?php
                                }
                            }
                            ?>
                        </div>
                        <div class="mt-3"><span id="showlogoMessage"></span></div>
                        ...
                        <div class="d-flex align-middle gap-3">
                            ...
                            <input type="text" class="form-control" id="websiteName" name="websiteName"
                                placeholder="website Name" value="<?php echo $row['web_name'] ?>">
                            <?php
                            }
                            ?>
                            <span class="material-symbols-outlined donebtn websiteName"
                                style="cursor: pointer;">done</span>
                        </div>
                    </div>
                    <div class="col-md-5 col-6 mt-5">
                        <form>
                            <button class="btn btn-primary mb-3 me-3 btn-file" style="transition: .3s;">Browse Logo
                                <input type="file" id="webLogo" name="webLogo" accept=".jpg, .jpeg, .png"
                                    onclick="return getWebLogo();">
                            </button>
                        </form>
                        <button class="btn btn-success" id="webLogoSubmit" type="submit"
                            style="transition: .3s;">Save</button>
                    </div>
                </div>
            </div>
